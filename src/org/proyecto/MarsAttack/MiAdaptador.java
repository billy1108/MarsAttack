...
public class MiAdaptador extends BaseAdapter { 
	  ...
	  public View getView(int position, View convertView,  
	    ...
	    case 0:  
	      imageView.setImageResource(R.drawable.icono_seccion_ovnis); 
	      break; 
	    case 1:  
	      imageView.setImageResource(R.drawable.icono_seccion_ovnis_2); 
	      break; 
	    default: 
	      imageView.setImageResource(R.drawable.icono_seccion_ovnis_3); 
	      break; 
	    } 
	    return view; 
	  } 
